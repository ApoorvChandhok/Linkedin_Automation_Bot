...
# search_terms = ["Python Developer", "Python Backend Developer", "Data Analyst", "Business Analyst", "Python Automation Engineer"] # Saved previous list for later
search_terms = ["Python Backend Developer", "Data Analyst", "Business Analyst", "Python Automation Engineer"]
...
about_company_bad_words = ["Crossover", "MLM", "Network Marketing"]    # (dynamic multiple search) or leave empty as [].
...
bad_words = ["No C2C", "No Corp2Corp", ".NET", "PHP", "Ruby", "CNC", "Security Clearance", "US Citizen", "USA Citizen", "Canada", "Embedded"]  # (dynamic multiple search) or leave empty as []. Case Insensitive.
...
current_experience = 3             # 3.5 years experience rounded down. Integers > -2 (Ex: -1, 0, 1, 2, 3, 4...)
##
