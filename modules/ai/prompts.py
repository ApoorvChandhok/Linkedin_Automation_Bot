...
6. "profile_match": Based strictly on the provided job description and general baseline matching, estimate a profile match percentage (0-100) and return it as a string (e.g., "85%").
7. "salary_extracted": If the job description mentions a salary, salary range, or compensation, extract it exactly as written. If not found, return "Unknown".
    ...
    "json_schema": {
        ...
        "schema": {
            ...
            "properties": {
                ...
                "profile_match": {"type": "string"},
                "salary_extracted": {"type": "string"}
            },
            "required": [
                "tech_stack",
                "technical_skills",
